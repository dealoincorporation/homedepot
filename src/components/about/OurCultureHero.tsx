    ...
    <section className="relative min-h-[380px] md:min-h-[480px] flex items-end overflow-hidden border-b border-border-primary bg-primary -mt-16 md:-mt-[89px]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pb-16 md:pb-24 pt-24 md:pt-32">
        ...
        >
          ...
          <span className="text-[11px] font-bold tracking-[0.25em] text-[#EE7125] uppercase">Our Community</span>
        </div>
        ...
        >
          OUR<br />
          <span className="text-[#EE7125]">CULTURE</span>
        </h1>
        ...
        >
          A vibrant community rooted in respect, inclusion, and a shared passion for helping people build their dream homes.
        </p>
      </div>
