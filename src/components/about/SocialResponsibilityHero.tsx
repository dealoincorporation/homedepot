...
const SocialResponsibilityHero: FC = () => {
  ...
  return (
    <section className="relative min-h-[380px] md:min-h-[480px] flex items-end overflow-hidden border-b border-border-primary bg-primary -mt-16 md:-mt-[89px]">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('/images/social responsibility page.png')",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pb-16 md:pb-24 pt-24 md:pt-32">
        ...
        >
          ...
          <span className="text-[11px] font-bold tracking-[0.25em] text-[#EE7125] uppercase">Our Impact</span>
        </div>
        ...
        >
          We believe in giving back—strengthening communities, protecting our planet, and supporting those who need it most.
        </p>
      </div>
...
export default SocialResponsibilityHero;
