...
const JobSearchResults: FC<JobSearchResultsProps> = ({ filters, onFilterClick }) => {
  ...
  return (
    <div>
      ...
      <div className="lg:hidden bg-secondary border-b border-border-primary px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-tertiary border border-border-primary rounded-xl text-xs font-bold text-text-primary hover:bg-tertiary/80 transition-all"
          >
      ...
      <div className="hidden lg:flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 bg-secondary/40 border border-border-primary rounded-2xl px-6 py-4">
        <div className="flex items-center gap-3 text-xs font-bold text-text-muted uppercase tracking-widest">
          <span>{startIndex}-{endIndex} of {totalJobs} jobs</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <select
                ...
                className="bg-tertiary border border-border-primary rounded-lg px-3 py-1.5 text-text-primary text-[10px] font-black appearance-none pr-8 focus:outline-none focus:border-[#EE7125]/50 transition-all"
              >
                <option value="proximity">Proximity</option>
                <option value="date">Date</option>
                <option value="relevance">Relevance</option>
              </select>
              <ChevronDown className="w-3 h-3 absolute right-2.5 top-1/2 -translate-y-1/2 text-text-muted pointer-events-none" />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-8 h-8 flex items-center justify-center bg-tertiary border border-border-primary rounded-lg text-text-primary disabled:opacity-30 disabled:cursor-not-allowed hover:bg-tertiary/80 transition-all"
          >
