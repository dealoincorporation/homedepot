      ...
      <div className="relative w-full">
        <div className="relative overflow-hidden">
          <img
            ...
            alt="Retail Management Career Opportunities at The Home Depot Canada"
...
export default RetailManagementHero;
