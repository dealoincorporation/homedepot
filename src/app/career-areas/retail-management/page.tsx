...
import RetailManagementHero from '@/components/career/RetailManagementHero';
import RetailManagementContent from '@/components/career/RetailManagementContent';
...
export default function RetailManagementPage() {
  ...
  return (
    <main>
      <RetailManagementHero />
      <RetailManagementContent />
      <RetailStoreRoles />
